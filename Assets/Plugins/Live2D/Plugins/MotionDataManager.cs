...
public struct MotionData
{
	...
	public Live2DMotion GetLiveMotion(int index)
	{
		return Live2DMotion.loadMotion(liveMotionMtnBytesFiles[index].bytes);
	}
	...
	{
		if (liveExpressionExpJsonFiles==null||liveExpressionExpJsonFiles.Length==0)
		{
			return null;
		}
