...
public class LiveCharacter : MonoBehaviour
{
    ...
    */
    ...
    public void StartIdleMotion()
    {
        if (idleMotion == null)
        {
            idleMotion = motionData.GetIdleLiveMotion();
        }
    ...
    {
        var calledMotion = motionData.GetLiveMotion(motionName);
    ...
    {
        var calledExpression = motionData.GetLiveExpression(expressionName);
...
#endif
        model.setMatrix(transform.localToWorldMatrix * canvasMatrix);
        model.draw();
    }
    ...
    {
        StartMotion(motionData.GetRandomLiveMotion());
        SetExpression(motionData.GetRandomLiveExpression());
    }
